...
void PerfAddressCache::cacheSymbol(const PerfElfMap::ElfInfo& elf, quint64 startAddr, quint64 value, quint64 size,
                                   const QByteArray& symname)
{
    ...
    symbols.insert(it, {offset, value, size, symname});
}
