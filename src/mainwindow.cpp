...
void MainWindow::setupFilterDisassemblyMenu() {
    ...
    auto *showFilteredDisassemblyBytesAction = filterDisassemblyMenu->addAction(tr("Filter instruction bytes"));
    ...
    auto *showFilteredDisassemblyAddressAction = filterDisassemblyMenu->addAction(tr("Filter instruction address"));
